    ...
    class << self
      ...
      def attributes
        [:additional_info, :address, :after_registration_closed_url, :after_registration_complete_url, :city, :country,
         ...
         :email_image_url, :facebook_share_message, :google_analytics_property_id, :invoice_change_cutoff_days, :invoice_extra, :invoice_number_format, :invoice_prefix, :invoice_tax_details,
         ...
         :receipt_footer_message, :register_button_label, :register_interest_form_label, :requires_billing_address, :requires_company_name, :requires_country, :show_additional_info, :show_banner,
         :show_company_field, :show_date, :show_description, :show_discount_code_field, :show_email_address, :show_lanyrd_schedule, :show_location, :show_logo, :show_past_tickets, :show_phone_number_field,
